...
class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnDiscoteca = (Button) findViewById(R.id.btnDiscoteca);
        btnDiscoteca.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                build_retrofit_and_get_response("night_club");
            }
        });
    }
        ...
        call.enqueue(new Callback<PlacesResponse>() {
            ...
            public void onResponse(Call<PlacesResponse> call, Response<PlacesResponse> response) {
                ...
                try {
                    ...
                    PlacesResponse respuesta = response.body();

                    List<Result> lugares = respuesta.getResults();
